                ...
                <div class="col-lg-12 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2--- mb-20">
                            ...
                            <h1 class="section-title">{{ $allServiceTitleInfo->serviceTitleOne }}<span>.</span></h1>

                        </div>
                        <div class="about-us-info-wrap-inner about-us-info-devide---">
                            <p>{{ $allServiceTitleInfo->serviceTitleTwo }}</p>
                        </div>
                        <div class="btn-wrapper animated">
                            <a href="{{ route('about_us') }}" class="theme-btn-1 btn btn-effect-1 text-uppercase">About Us</a>
                        </div>
                    </div>
                </div>
            </div>
