            ...
            <div class="card-body">
                ...
                <form class="row g-3" method="post" action="{{ route('portfolioDetail.store') }}" enctype="multipart/form-data">
                    ...
                    @csrf
                      ...
                      <div class="col-12">
                        <label for="inputAddress2" class="form-label">Address One</label>
                        <input type="text"  class="form-control"  name="clientName" id="inputAddress2">

                      </div>

                      <div class="col-12">
                        <label for="inputAddress2" class="form-label">Address Two</label>
                      ...
                      <div class="col-12">
                        ...
                        <small class="text-danger">Size : 850*650</small>
                      </div>
