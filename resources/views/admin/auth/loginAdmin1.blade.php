...
<head>
  ...
  <link href="{{asset('/')}}{{ $systemDataAll->siteIcon }}" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="{{asset('/')}}{{ $systemDataAll->adminSiteLogo}}" alt="">
                  <span class="d-none d-lg-block">{{ $systemDataAll->websiteName }}</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-12">
                      {{-- <p class="small mb-0">Don't have account? <a href="{{ route('registrationAdmin') }}">Create an account</a></p> --}}
                    </div>
                  </form>
