      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-header">
            <a type="button" class="btn btn-primary btn-sm" href="{{ route('team.create') }}">
   ...
   <table class="table datatable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $allSystemInfos->personalLine}}</td>
        <td>{{ $allSystemInfos->webLink}}</td>
        <td>
            <a type="button" class="btn btn-success btn-sm" href="{{ route('team.edit',$allSystemInfos->id) }}">
            ...
            <form id="delete-form-{{ $allSystemInfos->id }}" action="{{ route('team.destroy',$allSystemInfos->id) }}" method="POST" style="display: none;">
