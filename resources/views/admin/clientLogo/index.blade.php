      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-header">
            <a type="button" class="btn btn-primary btn-sm" href="{{ route('clientLogo.create') }}">
   ...
   <table class="table datatable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            <a type="button" class="btn btn-success btn-sm" href="{{ route('clientLogo.edit',$allSystemInfos->id) }}">
            ...
            <form id="delete-form-{{ $allSystemInfos->id }}" action="{{ route('clientLogo.destroy',$allSystemInfos->id) }}" method="POST" style="display: none;">
