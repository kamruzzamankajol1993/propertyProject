      ...
      <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" method="post" action="{{ route('messagePartOne.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" class="form-control" name="titleTwo" id="inputEmail4">
                    </div>
                    <div class="col-12">
