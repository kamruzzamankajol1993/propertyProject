                    ...
                    <div class="col-12">
                      ...
                      <div class="col-12">
                        ...
                        <div class="col-12">
                          ...
                          <input type="text" class="form-control"  name="image" value="{{ $allSystemInfo->image }}" id="inputAddress2">

                        </div>

                        <div class="col-12">
                            <label for="inputAddress2" class="form-label">Phone</label>
                            <input type="text" class="form-control"  name="phone" id="inputAddress2" value="{{ $allSystemInfo->phone }}">
